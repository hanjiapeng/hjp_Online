...
urlpatterns = [
    ...
    re_path('media/<?P<path>.*>$',serve,{'document_root':settings.MEDIA_ROOT}),  # 将文件或图片保存到media文件夹中路由
    # re_path(r'^static/(?P<path>.*)',serve,{'document_root':settings.STATIC_ROOT}),  # 处理静态文件
